...
`001-measurements.sql` is a single init script covering the whole schema
end-state (hypertable, unique `(room, time DESC)` index, compression) - see
`hub/CLAUDE.md` for how it got to that shape.
